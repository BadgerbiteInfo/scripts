...
curl -fsLS https://raw.githubusercontent.com/sentinel-official/networks/main/sentinelhub-2/genesis.zip -o <DIRECTORY>/genesis.zip
unzip <DIRECTORY>/genesis.zip -d <DIRECTORY>/.sentinelhub/config/
